    ...
    if (currentQuizSection === 'another' && currentQuestionIndex < anotherQuestions.length) {
        ...
        container.innerHTML = `
            <div class="page active" style="display:block">
                <div class="page-header"><span class="page-number">📝 Another Type - Question ${currentQuestionIndex + 1}/5</span></div>
        ...
        container.innerHTML = `
            <div class="page active" style="display:block">
                <div class="page-header"><span class="page-number">🍕 Food - Question ${currentQuestionIndex + 1}/5</span></div>
                <div class="question-text">${q.q}</div>
                <div class="options-container">
                    <div class="option-card" onclick="answerQuiz('${q.a.replace(/'/g, "\\'")}')">${q.a}</div>
                    <div class="option-card" onclick="answerQuiz('${q.b.replace(/'/g, "\\'")}')">${q.b}</div>
...
function showRiddle() {
    ...
    container.innerHTML = `
        <div class="page active" style="display:block">
            <div class="page-header"><span class="page-number">🔐 Riddle ${currentRiddle+1}/3</span></div>
            <div class="question-text">${r.text}</div>
            <p style="color:white; text-align:center;">Format: ${r.format}</p>
            <input type="text" id="riddleAnswer" class="riddle-input" placeholder="Type your answer...">
